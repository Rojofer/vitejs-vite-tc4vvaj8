      ...
      <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl h-[85vh] overflow-hidden flex flex-col border border-slate-200">
        ...
        <div className="p-5 bg-white border-t border-slate-100 flex justify-end gap-3 shrink-0">
          ...
          {(() => {
            ...
            // ADMIN o PROVEEDORES
            return (
              <button onClick={confirmarYGuardarReclamo} className="px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest bg-orange-500 text-white hover:bg-orange-600 shadow-lg shadow-orange-500/30 transition-all flex items-center gap-2 active:scale-95">
                <Send size={16} /> Disparar y Guardar
              </button>
            );
          })()}
        </div>
